...
class UNetWithTextCond(nn.Module):
    """
    3‑level U‑Net (Down×3 / Up×3) whose total parameter count
    is kept roughly equal to the original 2‑level version by
    reducing the base channel width from 32 → 16.
    """
